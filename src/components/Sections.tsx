export function Sections() {
  return (
    <div className="flex   w-[100%] items-center justify-between">
      ...
      <div className="bg-louge  h-[500px] w-[500px] flex flex-col items-center justify-center gap-12 hover:cursor-pointer group">
      ...
      <div className="bg-jacket bg-center h-[500px] w-[500px] flex flex-col items-center justify-center gap-12 hover:cursor-pointer group">
        <h2
          className="font-Inter font-bold text-5xl text-white group-hover:-translate-y-5 duration-200
        "
        >
